  ...
  module.exports = Librato = (function(_super) {
    ...
    function Librato(options) {
      ...
      setInterval(function() {
        ...
        if (_this.sent !== 0) {
          gauges.drop_pct = {
            value: _this.drops / _this.sent
          };
          gauges.error_pct = {
            value: _this.errors / _this.sent
          };
        }
        _this.resetVars();
    ...
    Librato.prototype.finish = function(alerts_sent, potential_drops) {
      return this.drops += potential_drops;
    };
