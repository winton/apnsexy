...
(function() {
  ...
  Apnshit = (function(_super) {
    ...
    function Apnshit(options) {
      ...
      }, Math.floor(this.options.timeout / 2));
    }
    ...
    Apnshit.prototype.checkForStaleConnection = function() {
      ...
      if (this.socket) {
        ...
        console.log('@socket.bytesRead', this.socket.socket.bytesRead);
        console.log('@bytes_read', this.bytes_read);
        console.log('@socket.bytesWritten', this.socket.socket.bytesWritten);
        console.log('@bytes_written', this.bytes_written);
    ...
    Apnshit.prototype.socketError = function(e) {
      ...
      return this.notifications = this.notifications.concat(_.reject(this.sent, function(n) {
        return n._written;
      }));
    };
