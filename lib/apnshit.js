  ...
  module.exports = Apnshit = (function(_super) {
    ...
    Apnshit.prototype.send = function(notification) {
      ...
      return this.connect().then(function() {
        ...
        if (_this.socketUnavailable()) {
          _this.buffer.push(notification);
          return;
        }
    ...
    Apnshit.prototype.socketData = function(data) {
      var error_code, identifier;
      if (data[0] === 8) {
        error_code = data[1];
        identifier = data.readUInt32BE(2);
        return console.log("notification failed:", identifier);
      }
    };
    ...
    Apnshit.prototype.socketDrain = function() {
      ...
      if (this.buffer.length) {
        return this.send(this.buffer.shift());
      }
    };
    ...
    Apnshit.prototype.socketUnavailable = function() {
