...
(function() {
  var Apnshit, Debug, Feedback, Notification, key, value, _ref,
  ...
  Apnshit = (function(_super) {
      ...
      if (notification) {
        ...
        return this.connect().then(function() {
          ...
          if (_this.socket.writable) {
            written = _this.socket.write(notification.data(), notification.encoding, function() {
              _this.debug("send#written", notification);
              _this.sending = false;
              return _this.sent_index = index;
            });
            if (!(written != null)) {
              return _this.debug("send#write_failed");
            }
          } else {
    ...
    Apnshit.prototype.socketData = function(data) {
      ...
      if (this.error_index != null) {
        ...
        this.debug('socketData#found_notification', notification);
        if (error_code === 8) {
