  ...
  Apnshit = (function(_super) {
    ...
    Apnshit.prototype.checkForStaleConnection = function() {
      ...
      if (this.stale_count >= 2) {
        ...
        total_sent = (this.sent_index + 1) || 0;
        potential_drops = this.potential_drops || 0;
        this.killSocket();
        this.resetVars();
        this.debug('checkForStaleConnection#stale');
        return this.emit('finish', total_sent, potential_drops);
      }
    };
    ...
    Apnshit.prototype.socketError = function(e) {
      ...
      if (this.error_index == null) {
        ...
        this.potential_drops += this.error_index - this.connect_index + 1;
